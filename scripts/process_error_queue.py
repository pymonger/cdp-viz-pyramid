...
def handle_delivery(channel, method_frame, header_frame, body):
    ...
    while COUNT > 0:
        ...
        print "2. Move message back on %s queue" % j["queue_name"]
        ...
        if option == '1': print "body: %s" % j["body"]
            ...
            channel2.queue_declare(queue=j['queue_name'], durable=True)
            channel2.basic_publish(exchange='',
                          routing_key=j['queue_name'],
                          body=j['body'],
